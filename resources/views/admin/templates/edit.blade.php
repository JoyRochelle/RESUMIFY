            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select id="template-badge-color" name="badge_color"
                        ...
                        <option value="slate"     {{ old('badge_color', $template->badge_color) === 'slate'     ? 'selected' : '' }}>Slate</option>
                        <option value="teal"      {{ old('badge_color', $template->badge_color) === 'teal'      ? 'selected' : '' }}>Teal</option>
                        <option value="gray"      {{ old('badge_color', $template->badge_color) === 'gray'      ? 'selected' : '' }}>Gray</option>
                    </select>
