<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="relative flex items-center justify-center gap-2 py-3 px-4 rounded-lg border border-outline-variant opacity-60 cursor-not-allowed select-none"
            aria-disabled="true" title="{{ __('messages.auth.social.linkedin_unavailable') }}">
            ...
            <span
                class="absolute -top-2 right-2 px-1.5 py-0.5 rounded-full bg-surface-container-low border border-outline-variant text-[9px] font-bold uppercase tracking-wider text-on-surface-variant">
                {{ __('messages.auth.social.in_development') }}
            </span>
        </div>
    </div>
</div>
