            ...
            <li class="flex items-start gap-3">
                ...
                @if (is_array($feature))
                    <div class="flex flex-col">
                        <span
                            class="font-body {{ $isPremium ? 'text-primary font-medium' : 'text-primary/80' }}">{{ $feature['title'] }}</span>
                ...
                @else
                    <span
                        class="font-body {{ $isPremium ? 'text-primary font-medium' : 'text-primary/80' }}">{{ $feature }}</span>
                @endif
            </li>
        @endforeach
