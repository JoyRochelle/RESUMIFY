...
<header
    class="h-auto min-h-[64px] py-4 lg:py-0 flex flex-col lg:flex-row justify-between items-center px-4 lg:px-8 w-full border-b border-primary/10 bg-surface shrink-0 z-30 gap-4 lg:gap-0">
