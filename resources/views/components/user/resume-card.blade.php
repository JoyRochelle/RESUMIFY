...
<article class="group bg-tertiary rounded-lg border border-primary/10 hover:border-primary/20 hover:shadow-[0_16px_32px_rgba(79,59,47,0.08)] hover:-translate-y-1 transition-all duration-200 ease-out overflow-hidden flex flex-col">
    <div class="aspect-[210/297] bg-surface-container-low overflow-hidden relative border-b border-primary/5">
        ...
        @else
            <div class="bg-tertiary h-full w-full shadow-sm rounded-sm p-4 space-y-3 transform group-hover:scale-105 group-hover:rotate-1 transition-transform duration-300 origin-top border border-primary/5">
        ...
        <div class="flex items-center justify-between border-t border-primary/5 pt-4">
            ...
            <div class="flex items-center gap-1">
                ...
                <button type="button"
                        ...
                        class="min-h-11 min-w-11 hover:bg-primary/5 hover:text-secondary rounded-full transition-colors text-primary/60 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-secondary/40">
                ...
                <button type="button" onclick="openDeleteModal('{{ $cvId }}')"
                        ...
                        class="min-h-11 min-w-11 hover:bg-red-50 hover:text-red-600 rounded-full transition-colors text-primary/60 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-red-300">
                    <span class="material-symbols-outlined text-[20px]" data-icon="delete" aria-hidden="true">delete</span>
                </button>
            </div>
            @else
            <button type="button" class="min-h-11 min-w-11 hover:bg-surface-container-low rounded-full transition-colors text-primary/60 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-secondary/40" aria-label="More actions">
