...
@section('content')
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 mb-16 sm:mb-24 max-w-5xl mx-auto px-4 sm:px-8">
        ...
        <x-product.pricing-card plan="Starter" price="Rp 0" period="forever" :features="[$basicResumeLabel, 'Standard Templates']" :disabledFeatures="['No AI Enhancement']"
    ...
    <section class="max-w-3xl mx-auto px-4 sm:px-8 py-16 sm:py-24" x-data="{ active: null }">
        <h2 class="text-3xl md:text-4xl font-headline font-bold text-center mb-12 tracking-tighter text-primary">Frequently
            Asked Questions</h2>
        <div class="space-y-4">
            {{-- FAQ 1 --}}
            <div class="bg-surface-container-lowest rounded-sm overflow-hidden border border-primary/5 shadow-sm">
                ...
                <div x-show="active === 1" x-collapse class="px-6 pb-6 text-outline font-body leading-relaxed text-sm">
                    Yes, you can cancel your subscription at any time through your account settings. Your premium access
            ...
            <div class="bg-surface-container-lowest rounded-sm overflow-hidden border border-primary/5 shadow-sm">
                ...
                <div x-show="active === 2" x-collapse class="px-6 pb-6 text-outline font-body leading-relaxed text-sm">
                    We accept credit cards (Visa, Mastercard), PayPal, and various local digital wallets to facilitate your
            ...
            <div class="bg-surface-container-lowest rounded-sm overflow-hidden border border-primary/5 shadow-sm">
                ...
                <div x-show="active === 3" x-collapse class="px-6 pb-6 text-outline font-body leading-relaxed text-sm">
                    Our AI analyzes job descriptions and provides relevant keyword suggestions, optimizes bullet point
                    grammar, and ensures your resume format is well-read by ATS systems.
                </div>
            </div>
        </div>
    </section>
