                        ...
                        <form class="section-form" data-section-id="{{ $targetJob->id ?? '' }}">
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div class="relative group mt-2">
                                    ...
                                    <textarea name="job_description" class="auto-save w-full bg-surface-container-low rounded-lg scroll-pad-b ring-1 ring-inset ring-primary/10 focus:ring-secondary p-4 text-sm text-primary leading-relaxed custom-scrollbar outline-none transition-colors duration-200 resize-none placeholder:text-primary/30" rows="6" placeholder="{{ __('messages.editor.sections.target_job.job_description_placeholder') }}">{{ $targetJobContent['job_description'] ?? '' }}</textarea>
                                </div>
                            </div>
                        </form>
