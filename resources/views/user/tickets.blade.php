...
@section('title', 'My Support Tickets - Resumify')
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 md:px-12 py-8 md:py-16">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <h1 class="text-2xl font-headline font-bold text-primary">My Support Tickets</h1>
                </div>
            ...
            <div class="bg-white rounded-3xl border border-primary/5 shadow-sm overflow-hidden">
                ...
                <div class="py-16 text-center">
                    ...
                    <p class="text-sm font-label text-primary/40 mb-4">No support tickets yet</p>
                    <a href="{{ route('user.help') }}#contact"
