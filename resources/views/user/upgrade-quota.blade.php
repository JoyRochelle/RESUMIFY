    ...
    <main class="flex-1 overflow-y-auto custom-scrollbar bg-primary/5 pb-20 md:pb-0">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-12 py-8 md:py-16">
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 mb-12 md:mb-24 max-w-5xl mx-auto">
                ...
                <x-product.pricing-card plan="Starter" price="Rp 0" period="forever" :features="['1 Active Resume', 'Standard Templates']" :disabledFeatures="['No AI Enhancement']"
            ...
            <section
                ...
                <div
                    ...
                    <span class="font-label text-xs font-bold tracking-widest text-primary uppercase">30-Day Money-Back
                        Guarantee</span>
                </div>
                <p class="mt-8 text-primary/60 text-sm font-body max-w-lg mx-auto">
                    Your transactions are protected with AES-256 bit encryption. Your privacy and data security are our top
                    priorities.
                </p>
            </section>
            ...
            <section class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-16">
                ...
                <x-user.testimonial-card
                    ...
                    name="X" role="Senior Product Manager" :avatar="asset('images/sadakiyo.jpg')" />
