...
<body class="bg-surface font-body text-primary overflow-hidden h-screen flex">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        {{-- Page Header --}}
        <x-user_dashboard.page-header title="AI Assistant: ATS Optimizer">
            <x-user_dashboard.button variant="ghost" class="text-sm px-3">Instructions</x-user_dashboard.button>
            <x-user_dashboard.button variant="primary" icon="history" iconClass="text-[18px]" class="text-sm px-3">History</x-user_dashboard.button>
                ...
                <div class="p-4 lg:p-6 lg:overflow-y-auto custom-scrollbar space-y-6 lg:h-full">
                    ...
                    <div class="bg-tertiary rounded-xl p-6 border border-primary/10 shadow-sm flex flex-col gap-4">
                        <div class="flex justify-between items-center">
                            ...
                            <x-user_dashboard.button variant="text" icon="upload_file" iconClass="text-sm" class="!px-0 hover:underline">Upload PDF</x-user_dashboard.button>
                        </div>
                    ...
                    <x-user_dashboard.button variant="primary" class="w-full py-4 text-md shadow-lg group flex items-center justify-center gap-3">
                        Analyze Match 
                ...
                <div class="max-w-4xl mx-auto space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-tertiary rounded-2xl p-8 border border-primary/10 shadow-sm flex flex-col items-center justify-center text-center">
                            <div class="mb-4">
                                <x-user_dashboard.score-circle :score="78" size="lg" />
                            </div>
                        ...
                        <div class="bg-tertiary rounded-2xl p-6 border border-primary/10 shadow-sm md:col-span-2">
                            ...
                            <div class="flex flex-wrap gap-2 mb-4">
                                <x-user_dashboard.keyword-tag variant="danger">Laravel 12</x-user_dashboard.keyword-tag>
                                <x-user_dashboard.keyword-tag variant="neutral">Docker</x-user_dashboard.keyword-tag>
                                <x-user_dashboard.keyword-tag variant="neutral">AWS</x-user_dashboard.keyword-tag>
                            </div>
                    ...
                    <div class="bg-tertiary rounded-2xl p-6 border border-primary/10 shadow-sm">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <x-user_dashboard.keyword-tag variant="success" class="py-2 rounded-xl">Lead</x-user_dashboard.keyword-tag>
                            <x-user_dashboard.keyword-tag variant="success" class="py-2 rounded-xl">Spearheaded</x-user_dashboard.keyword-tag>
                            <x-user_dashboard.keyword-tag variant="success" class="py-2 rounded-xl">Optimized</x-user_dashboard.keyword-tag>
                            <x-user_dashboard.keyword-tag variant="success" class="py-2 rounded-xl">Engineered</x-user_dashboard.keyword-tag>
                        </div>
                    </div>
                    ...
                    <section class="glass-effect rounded-2xl p-8 border border-secondary/20 relative overflow-hidden">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                            <x-user_dashboard.insight-item title="Quantify Impact">
